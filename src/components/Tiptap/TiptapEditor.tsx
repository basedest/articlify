...
export function TiptapEditor({
    ...
    const editor = useEditor({
        ...
        editorProps: {
            attributes: {
                class: 'tiptap ProseMirror min-h-[200px] max-w-none px-4 py-3 focus:outline-none',
            },
        },
        onUpdate: ({ editor }) => {
    ...
    if (!editor) {
        return (
            <div className={`border-input bg-background rounded-lg border ${className}`}>
    ...
    return (
        <div className={`border-input bg-background overflow-hidden rounded-lg border ${className}`}>
