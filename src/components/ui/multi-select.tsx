...
export function MultiSelect({
    ...
    return (
        <div className={cn('relative', className)}>
            <div className="border-input dark:bg-input/30 ring-offset-background focus-within:ring-ring flex min-h-10 w-full flex-wrap items-center gap-1 rounded-md border bg-transparent px-3 py-2 text-sm focus-within:ring-1">
                {selected.map((item) => {
